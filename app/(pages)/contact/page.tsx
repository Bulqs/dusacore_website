...
export default function ContactPage() {
  const [selectedCode, setSelectedCode] = useState(countryCodes[2]); // Defaulting to Nigeria
    ...
    <div className="w-full flex flex-col relative">
      ...
      <section className="w-full py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          >
            <motion.h5 variants={formItemVariants} className="text-2xl sm:text-3xl font-bold text-appTitleBgColor mb-8">
            ...
            <form className="space-y-4">
              <motion.div variants={formItemVariants}>
                ...
                <input
                  required
                  type="text"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 focus:ring-1 focus:ring-appBanner focus:outline-none transition-colors"
                  ...
                  <div className="flex gap-1">
                    <div className="relative">
                      <button
                        ...
                        className="flex items-center gap-2 bg-gray-50 border border-gray-200 px-[15px] py-[13px] focus:ring-1 focus:ring-appBanner focus:outline-none text-sm min-w-[96px] h-full transition-colors"
                      >
                      ...
                      {dropdownOpen && (
                        <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 shadow-lg z-20 min-w-[200px] max-h-[250px] overflow-y-auto custom-scrollbar">
                          {countryCodes.map((c) => (
                            <button
                              key={c.code}
                              type="button"
                              ...
                              className={`flex items-center gap-2 w-full px-3 py-2.5 text-sm hover:bg-gray-50 text-left ${selectedCode.code === c.code ? "bg-appLightPurple/10 text-appPurple font-bold" : ""}`}
                            >
                              {flag(c.code)}
                              <span className="truncate">
                                {c.code}{" "}
                                <span className="text-gray-400 font-normal">{c.name}</span>
                              </span>
                            </button>
                          ))}
                        </div>
                    ...
                    <input
                      required
                      type="tel"
                      className="w-full px-4 py-[13px] bg-gray-50 border border-gray-200 focus:ring-1 focus:ring-appBanner focus:outline-none h-full transition-colors"
              ...
              {/* NEW FIELD: Area of Interest */}
              <motion.div variants={formItemVariants}>
                <label className="block text-sm font-semibold text-gray-700 mb-1.5 relative">
                  Area of Interest
                </label>
                <div className="relative">
                    <select 
                        ...
                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 focus:ring-1 focus:ring-appBanner focus:outline-none appearance-none cursor-pointer transition-colors"
                    >
              ...
              <motion.div variants={formItemVariants}>
                ...
                <textarea
                  required
                  rows={4}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 focus:ring-1 focus:ring-appBanner focus:outline-none resize-none transition-colors"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full bg-appBanner text-white py-3.5 font-bold shadow-lg hover:bg-appNav transition-all duration-300"
              >
                Get Notified
              </motion.button>
            </form>
          ...
          <motion.div 
            ...
            whileInView="show"
            viewport={{ once: true, margin: "-100px" }}
            className="relative w-full max-w-[80%] mx-auto h-[400px] sm:h-full sm:min-h-[550px] overflow-hidden rounded-2xl hidden lg:block"
          >
            <Image
              src={contactImg}
              alt="Contact"
