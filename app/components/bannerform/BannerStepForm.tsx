...
//         pickupType: isSenderEditable ? PickupTypes.SAS : PickupTypes.M2A, 
...
//         // Keep itemDescription synced with packageDescription for customs
...
//     const customInputClasses = "w-full px-4 py-3 rounded-xl bg-white/80 backdrop-blur-sm border border-gray-200 shadow-sm outline-none text-black font-semibold text-sm focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/50 transition-all";
...
//                                             <label htmlFor="ins1" className="ml-2 text-sm font-bold text-gray-700">Add Global Insurance?</label>
//                                         </motion.div>
//                                     </div>
//                                 </div>
