...
const Banner = () => {
    ...
    return (
        <>
        <section className='w-full relative min-h-[580px] lg:max-h-[580px] py-6 sm:py-8 px-4 sm:px-6 md:px-12 flex items-center justify-center overflow-hidden bg-gradient-to-t from-appPurple via-appLightPurple via-40% to-white '>
            <div className='max-w-7xl mx-auto flex flex-col lg:flex-row gap-6 lg:gap-12 w-full items-center justify-between relative z-10'>
                ...
                ========================================= */}
                <div className='flex flex-col w-full lg:w-[48%] gap-4 lg:gap-6'>
                    <div>
                    ...
                    <div className='flex flex-col sm:flex-row gap-4 mt-4'>
                        <button 
                            ...
                            className='bg-appPurple text-white px-8 py-3.5 rounded-md font-bold text-base shadow-md hover:bg-appNav transition-colors duration-300 active:scale-95'
                        >
                            Book a consultation
                        </button>
                        <Link 
                            href="/services"
                            className='bg-white text-appPurple border border-appPurple px-8 py-3.5 rounded-md font-bold text-base shadow-md hover:bg-gray-50 transition-colors duration-300 active:scale-95 inline-flex items-center justify-center'
                        >
                ...
                ========================================= */}
                <div className='w-full lg:w-[48%] flex justify-center lg:justify-end mt-10 lg:mt-0'>
                    <div className='bg-white p-8 rounded-xl shadow-2xl w-full max-w-xl flex flex-col gap-3 border border-gray-100'>
                        
                        <div>
                            <h3 className='text-appBlack font-semibold text-xl'>
                                Let&rsquo;s connect to help you and your team.
                            </h3>
                        </div>
                                ...
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <div className='flex flex-row w-full'>
                                        <div className="relative">
                                            ...
                                            {dropdownOpen && (
                                                <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 shadow-lg z-20 min-w-[180px] max-h-[200px] overflow-y-auto">
                                                    {countryCodes.map((c) => (
                                                        <button
                                                            key={c.code}
                                                            type="button"
                                ...
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <div className="relative">
                                        <select 
                                            ...
                                            className='w-full bg-white border border-gray-300 px-4 py-1.5 text-appBlack focus:outline-none focus:border-appPurple focus:ring-1 focus:ring-appPurple transition-all appearance-none cursor-pointer'
                                            required
                                        >
